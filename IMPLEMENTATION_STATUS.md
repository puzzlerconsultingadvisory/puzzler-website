...
- **Street address removed (2026-09-12, founder request).** The Annapolis street address no longer appears anywhere on the site: homepage footer, the legal and video pages' footers, the 404 page, and the `streetAddress` and `postalCode` in the Organization schema. City and state (Annapolis, MD) remain in the schema and the search description as a service-area signal; phone and email are unchanged. Say if the city should go too.
