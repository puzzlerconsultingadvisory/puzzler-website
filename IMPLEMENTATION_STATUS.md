...
- **Street address removed (2026-09-12, founder request).** The Annapolis street address no longer appears anywhere on the site: homepage footer, the legal and video pages' footers, the 404 page, and the `streetAddress` and `postalCode` in the Organization schema. Per the founder's follow-up the same day, the locality is now Calvert County, Maryland (schema `location` and `areaServed`, search description) with the Washington, DC metropolitan area, Maryland, Virginia, and Washington, DC listed as areas served; "Annapolis" no longer appears anywhere on the site. Phone and email are unchanged.
